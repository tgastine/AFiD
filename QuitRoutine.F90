...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      ...
      if(errorcode==166) then 
        write(6,168) dt 
168     format(10x,'dt too small, DT= ',e14.7)
      else if(errorcode==165) then
        write(6,164) 
164     format(10x,'cfl too large  ')
      else if(errorcode==266) then
        write(6,268)
268     format(10x,'velocities diverged')
      else if(errorcode==169) then
        write(6,178) 
        write(6,179) 
        write(6,180)                 
